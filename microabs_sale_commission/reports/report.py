...
class SaleCommissionReportWizard(models.Model):
    ...
    bank_acc_no = fields.Char('Account No.')
    bb_contact = fields.Char('Bank Name')
    company_name = fields.Char('Beneficiary Name')
    company_address = fields.Char('Beneficiary Address')
    ...
    total_due = fields.Float(string="Amount Due")
