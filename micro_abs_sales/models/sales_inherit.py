...
class SaleOrderInherit(models.Model):
    ...
    def action_confirm(self):
        if self.customer_order_value != self.amount_total:
            ...
            raise ValidationError("PO No. is not provided!! Please enter PO no. in order to confirm Sale Order")
        else:
    ...
    def get_vat_values(self):
        ...
        if self.partner_id:
            ...
            self.official_contact_id = self.partner_id.official_contact_ids.id
            self.official_contact_two_id = self.partner_id.official_contact_two_ids.id
