...
class PartnerPaymentDetails(models.Model):
    ...
    official_contact_ids = fields.Many2one("res.partner", string='Official Contact 1')
    official_contact_two_ids = fields.Many2one("res.partner", string='Official Contact 2')
